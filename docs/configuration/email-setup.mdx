---
title: Email Setup
description: vsForms & Emails
---

This page explains how to configure email notifications in vsForms.
...
vsForms uses Laravel's mail system. For more detailed information, you can refer to the [Laravel Mail documentation](https://laravel.com/docs/master/mail).
