...
description: "Set up vsForms locally for development"
---
...
2. Clone the repository and install dependencies:
   ...
   ```bash
   git clone git@github.com:JhumanJ/vsForms.git && cd vsForms
...
6. Set up Herd:
   ...
   - Add your vsForms's `api` directory to Herd
...
8. Access your local vsForms installation:
