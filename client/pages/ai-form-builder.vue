<template>
  <div class="flex-1">
      ...
      <div class="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span
              class="text-transparent bg-clip-text bg-gradient-to-r lg:block from-blue-600 to-blue-400"
        ...
        <div class="max-w-6xl mx-auto mt-12 sm:mt-16">
          <div
            class="p-2 -m-2 rounded-xl bg-blue-900/5 backdrop-blur-sm ring-1 ring-inset ring-blue-900/10 lg:-m-4 lg:rounded-2xl lg:p-4"
          >
            <video
              class="rounded-md shadow-xl ring-1 ring-gray-200 shadow-blue-600/10 ring-blue-900/10"
              controls
              autoplay
              loop
              muted
        ...
        <div
          class="grid grid-cols-1 gap-8 mt-12 lg:grid-cols-3 sm:max-w-lg lg:max-w-5xl sm:mx-auto sm:gap-10 sm:mt-16"
        >
    ...
    <section class="py-12 bg-white sm:py-16 lg:py-20 xl:py-24">
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <p
            class="mt-4 text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl lg:leading-tight"
          >
        ...
        <div
          class="mt-8 space-y-16 text-center lg:text-left sm:max-w-md sm:mx-auto lg:max-w-none lg:space-y-20 xl:space-y-24 sm:mt-12 lg:mt-16"
        >
          <div
            class="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between lg:gap-12"
          >
            <img
              class="w-full bg-gray-300 shadow-sm lg:flex-1 lg:shrink-0 rounded-2xl ring-1 ring-gray-200"
              src="/img/pages/ai_form_builder/step-1.svg"
              alt=""
            >

            <div
              class="items-center justify-center hidden w-16 h-16 text-2xl font-semibold leading-none text-blue-600 border-2 border-blue-200 rounded-full bg-blue-50 xl:inline-flex"
            >
              1
            </div>
            ...
            <div class="lg:flex-1 lg:shrink-0">
              ...
              <h3
                class="text-2xl font-semibold text-gray-900 sm:text-3xl lg:text-4xl lg:mt-8"
              >
              ...
              <p
                class="mt-4 text-base font-medium leading-7 text-gray-500 sm:text-lg sm:leading-8"
              >
                vsForms is an easy-to-use online form creator letting you create a
                beautiful web form in a fraction of the time you're used to it taking. Whether you need to create
                contact forms and trip intake forms, you will no longer need to
          ...
          >
            <img
              class="w-full bg-gray-300 shadow-sm lg:flex-1 lg:shrink-0 rounded-2xl ring-1 ring-gray-200 lg:order-3"
              src="/img/pages/ai_form_builder/step-2.svg"
              alt=""
            >
            <div
              class="items-center justify-center hidden w-16 h-16 text-2xl font-semibold leading-none text-blue-600 border-2 border-blue-200 rounded-full lg:order-2 bg-blue-50 xl:inline-flex"
            >
              2
            </div>
            ...
            <div class="lg:flex-1 lg:shrink-0 lg:order-1">
              ...
              >
                ...
                more responses than ordinary ones? On vsForms, you can customize
    ...
    <!--          <div class="grid grid-cols-1 gap-6 mt-8 sm:grid-cols-2 lg:grid-cols-4 sm:mt-12 lg:mt-16">-->
    <!--            <div-->
    <!--              class="overflow-hidden transition-all duration-150 bg-white shadow-sm rounded-2xl ring-1 ring-gray-200 hover:shadow-lg hover:-translate-y-2">-->
...
-->
    ...
    <!--                  Example 1-->
    <!--                </h3>-->
    <!--                <p class="mt-2 text-base font-medium text-gray-500 line-clamp-2">-->
...
-->
    ...
    <!--&lt;!&ndash;            </h4>&ndash;&gt;-->
    <!--&lt;!&ndash;            <p class="mt-4 text-base font-medium leading-7 text-gray-500 sm:text-xl sm:leading-9">&ndash;&gt;-->
    <!--&lt;!&ndash;              Save time and effortlessly create forms with vsForms&ndash;&gt;-->
    <!--&lt;!&ndash;            </p>&ndash;&gt;-->

    <!--&lt;!&ndash;            <div class="flex justify-center mt-8">&ndash;&gt;-->
    ...
    <!--&lt;!&ndash;            <ul&ndash;&gt;-->
    <!--&lt;!&ndash;              class="flex flex-wrap items-center justify-center mt-8 text-sm font-medium text-gray-900 sm:mt-12 gap-x-6 gap-y-4">&ndash;&gt;-->
    <!--&lt;!&ndash;              <li class="flex items-center gap-2">&ndash;&gt;-->
    <!--&lt;!&ndash;                <svg aria-hidden="true" class="w-5 h-5 text-gray-400 shrink-0" xmlns="http://www.w3.org/2000/svg"&ndash;&gt;-->
    ...
    <!-- START FAQS -->
    <!--    <section class="py-12 bg-white border-t border-gray-200 sm:py-16 lg:py-20 xl:py-24">-->
    <!--      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">-->
    <!--        <div class="max-w-3xl mx-auto text-center">-->
    <!--          <h2 class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl lg:leading-tight">-->
    ...
    <!--          <dl class="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-8 sm:gap-y-16 lg:gap-x-10">-->
    <!--            <div>-->
    <!--              <dt class="text-base font-medium leading-7 text-gray-900 sm:text-lg sm:leading-8">-->
    ...
    <!-- START CTA -->
    <section
      class="py-12 bg-gradient-to-b from-gray-100 to-white sm:py-16 lg:pt-20 xl:pt-24"
    >
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div class="max-w-3xl mx-auto mt-8 text-center sm:mt-12">
          <h2
            class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl lg:leading-tight"
          >
          ...
          <ul
            class="flex flex-wrap items-center justify-center mt-8 text-sm font-medium text-gray-900 sm:mt-12 gap-x-6 gap-y-4"
          >
...
useOpnSeoMeta({
  ...
  description:
    "Transform your ideas into fully functional forms with vsForms Builder + Toby AI – quick, accurate, and tailored to fit any requirement.",
})
defineRouteRules({
  swr: 3600,
})
