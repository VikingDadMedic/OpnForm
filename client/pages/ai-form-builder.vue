    ...
    >
      ...
      <div class="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
        <div class="max-w-4xl mx-auto text-center">
          ...
          >
            Say goodbye to tedious form building with vsForms's new
            <span
        ...
        >
          ...
          >
            ...
            <div class="lg:flex-1 lg:shrink-0">
              ...
              >
                vsForms's easy-to-use online form creator lets you create a
...
useOpnSeoMeta({
  ...
  description:
    "Transform your ideas into fully functional forms with vsForms AI Builder – quick, accurate, and tailored to fit any requirement.",
})
defineRouteRules({
  swr: 3600,
})
